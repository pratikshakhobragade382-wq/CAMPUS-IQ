...
const studentRoutes =
  require("../modules/student/student.routes");

const staffRoutes =
  require("../modules/staff/staff.routes");

const parentRoutes =
  require("../modules/parent/parent.routes");

const attendanceRoutes =
  require("../modules/attendance/attendance.routes");

const assignmentRoutes =
  require("../modules/assignment/assignment.routes");

const examRoutes =
  require("../modules/exam/exam.routes");

const classRoutes =
  require("../modules/class/class.routes");

const departmentRoutes =
  require("../modules/department/department.routes");

const sectionRoutes =
  require("../modules/section/section.routes");

const dashboardRoutes =
  require("../modules/dashboard/dashboard.routes");

const academicYearRoutes =
  require("../modules/academicYear/academicYearRoutes");

const feeRoutes =
  require("../modules/fee/fee.routes");

const holidayRoutes =
  require("../modules/holiday/holiday.routes");
...
const customFieldsRoutes =
  require("../modules/custom-fields/custom-fields.routes");
...
const subjectRoutes =
  require("../modules/master/subject.routes");

const aiRoutes =
  require("../modules/ai/ai.routes");

const performanceRoutes =
  require("../modules/performance/performance.routes");
...
/*
 * Parent AI Performance
 *
 * Final endpoint:
 *
 * GET /api/v1/parents/performance
 *
 */
