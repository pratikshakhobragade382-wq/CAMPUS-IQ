        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200">
          {!isCollapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-gray-900">CampusIQ</span>
            </div>
          )}
          <button
            onClick={toggleSidebar}
        ...
        {!isCollapsed && (
          <div className="p-4 border-t border-gray-200">
            <div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl p-4 text-white">
              ...
              <button className="w-full bg-white text-primary-600 rounded-lg py-1.5 text-xs font-medium hover:bg-gray-100 transition-colors duration-200">
                Upgrade Now
              </button>
            </div>
          </div>
