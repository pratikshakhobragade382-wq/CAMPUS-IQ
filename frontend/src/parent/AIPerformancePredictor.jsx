...
const normalizeAttendanceTrend = (trend) => {
  if (!Array.isArray(trend)) {
    return [];
  }
...
const extractTracker = (responseData) => {
...
const getPerformance = async (academicYearId) => {
  ...
  const response = await axiosClient.get(
    `/parents/performance${query}`
  );

  return extractTracker(response?.data);
};
...
const buildRecommendations = ({
  ...
  if (
    ...
    recommendations.push({
      title: "Strengthen assignment consistency",
      description:
  ...
  if (
    ...
    recommendations.push({
      title: "Focus on examination preparation",
      description:
    ...
    recommendations.push({
      title: "Increase revision before assessments",
      description:
  ...
  weakSubjects.forEach((subject) => {
    recommendations.push({
      title: `Give additional attention to ${subject.name}`,
      description:
  ...
  if (
    ...
    recommendations.push({
      title: "Maintain the current study routine",
      description:
  ...
  if (recommendations.length === 0) {
    recommendations.push({
      title: "Continue regular academic monitoring",
      description:
...
export default function AIPerformancePredictor() {
  ...
  const rawSubjects = Array.isArray(
    tracker?.subjects
  )
    ? tracker.subjects
    : [];
    ...
    return (
      <div className="performance-page">
        <div className="performance-loading">
          ...
          <p>
            We are securely retrieving the
  ...
  return (
    <div className="performance-page">
      ...
      <div className="performance-topbar">
        ...
        <div className="academic-year-control">
          <label>
        ...
        <div className="chart-card">
          <div className="chart-header">
            <div>
              ...
              <p>
                Compare the student's available
                subject scores.
              </p>
            </div>
